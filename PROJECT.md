...
The repository currently has no required status contexts on `main`. Action consumers use versioned Git refs such as `v1`; production proof is GitHub main/tag readback, action metadata validation, and successful downstream consumer workflow runs.
